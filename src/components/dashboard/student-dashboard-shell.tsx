...
import { STUDENT_NAV_ITEMS } from "@/lib/constants/student-dashboard";
  ...
  return (
    <nav className="flex flex-col gap-1 p-4">
      <div className="mb-6 px-3">
        ...
        <p className="text-muted-foreground mt-1 text-xs">Student Dashboard</p>
      </div>
...
export function StudentDemoBanner() {
  ...
  return (
    <div className="bg-accent/20 border-accent/30 flex items-center gap-3 border-b px-4 py-2.5 text-sm">
      ...
      <p className="flex-1">
        <strong>Demo mode:</strong> Bookings are saved locally. Use the same email across requests to
...
export function StudentDashboardShell({ children, title, description }: StudentDashboardShellProps) {
